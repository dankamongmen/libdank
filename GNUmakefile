...
PTHREAD_CFLAGS:=-std=gnu99 $(PTHREAD_DFLAGS) $(PTHREAD_IFLAGS) $(XML_IFLAGS) $(SSL_IFLAGS) $(ADNS_IFLAGS) $(FFLAGS) $(MFLAGS) $(WFLAGS)
CFLAGS:=-std=gnu99 $(PTHREAD_DFLAGS) $(XML_IFLAGS) $(SSL_IFLAGS) $(ADNS_IFLAGS) $(FFLAGS) $(MFLAGS) $(WFLAGS)
...
LIBDANK_LFLAGS:=$(LFLAGS) $(CURSES_LFLAGS) $(SHM_LFLAGS) $(XML_LFLAGS) $(SSL_LFLAGS) $(ADNS_LFLAGS) $(PMC_LFLAGS) $(PTHREAD_LFLAGS)
